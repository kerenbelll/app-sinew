  ...
  return (
    <section className="relative min-h-screen bg-black text-white overflow-hidden">
      ...
      <div className="pointer-events-none absolute -z-10 inset-0">
        <div className="absolute -top-24 left-1/2 -translate-x-1/2 w-[40rem] h-[40rem] rounded-full blur-3xl opacity-20 bg-[#98f5e1]" />
      </div>
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 py-28 md:py-36">
        ...
        >
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
            {["Masterclasses", "Talleres", "Plan Global", "Formación"].map((t) => (
              <span
                key={t}
