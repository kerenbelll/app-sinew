  ...
  return (
    <section className="relative min-h-screen bg-black text-white overflow-hidden">
      ...
      <div className="pointer-events-none absolute -z-10 inset-0">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 w-[44rem] h-[44rem] rounded-full blur-3xl opacity-15 bg-[#98f5e1]" />
      </div>
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 py-28 md:py-36">
        ...
        >
          ...
          <div className="mt-10 h-2 w-full rounded-full bg-white/10 overflow-hidden">
            <div className="h-full w-3/4 animate-pulse bg-mint/80" />
          </div>

          <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
            {["Networking", "Eventos", "Co-creación", "Proyectos"].map((t) => (
              <span
                key={t}
          ...
          <div className="pointer-events-none absolute -top-6 -left-6 size-24 rounded-full bg-mint/20 blur-2xl" />
          <div className="pointer-events-none absolute -bottom-14 right-14 size-40 rounded-full bg-mint/10 blur-3xl" />
        </div>
      </div>
    </section>
  );
